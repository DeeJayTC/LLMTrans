...
public sealed class GenericTestFactory : WebApplicationFactory<Program>
{
    ...
    private readonly string _dbPath = Path.Combine(Path.GetTempPath(), $"adaptiveapi-gen-{Guid.NewGuid():N}.db");
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.AddSingleton<AdaptiveApi.Core.Abstractions.ITranslator>(FakeTranslator);
        });
    ...
    public async Task Additional_headers_are_added_to_upstream_request()
    {
        var config = """
        {
          "upstream": {
            ...
            "additionalHeaders": { "X-Client-Name": "adaptiveapi-test" }
          },
        ...
        var captured = Assert.Single(_factory.Upstream.Requests);
        Assert.Equal("adaptiveapi-test", captured.Headers["X-Client-Name"]);
    }
