...
using CoreFormality = LlmTrans.Core.Abstractions.Formality;
using CoreTagHandling = LlmTrans.Core.Abstractions.TagHandling;
using CoreTranslator = LlmTrans.Core.Abstractions.ITranslator;
using CoreTranslationRequest = LlmTrans.Core.Abstractions.TranslationRequest;
using CoreTranslationResult = LlmTrans.Core.Abstractions.TranslationResult;
...
/// model_type, formality, tag handling, and ignore_tags=llmtrans so our
