...
internal static class PluginLoader
{
    ...
    ///   2. `LlmTrans.*.dll` files in the Api's base directory (plugin DLLs dropped next
    ...
    public static IReadOnlyList<IWebPlugin> Discover(ILogger? log = null)
    {
        ...
        ScanDirectory(baseDir, "LlmTrans.*.dll", plugins, seenTypes, seenAssemblies, log);
