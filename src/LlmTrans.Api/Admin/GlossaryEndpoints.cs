...
public static class GlossaryEndpoints
{
    ...
    private static async Task<IResult> Create(CreateGlossaryDto dto, LlmTransDbContext db, CancellationToken ct)
    {
    ...
    private static async Task<IResult> Get(string id, LlmTransDbContext db, CancellationToken ct)
    {
    ...
    private static async Task<IResult> Delete(string id, LlmTransDbContext db, CancellationToken ct)
    {
    ...
    private static async Task<IResult> ListEntries(string id, LlmTransDbContext db, CancellationToken ct)
    {
