...
async function send() {
  ...
  try {
    ...
    if (targetLang.value) headers['X-LlmTrans-Target-Lang'] = targetLang.value;
    if (sourceLang.value) headers['X-LlmTrans-Source-Lang'] = sourceLang.value;
    headers['X-LlmTrans-Mode'] = mode.value;
      ...
      <div class="card flex flex-col overflow-hidden">
        ...
        <div class="card-body text-sm text-surface-700">
          <ul class="list-disc pl-5 space-y-1">
            <li>The <span class="font-mono">X-LlmTrans-Target-Lang</span> and
              <span class="font-mono">X-LlmTrans-Source-Lang</span> headers override your route's
